...
@Lob
    ...
    private SimpleDateFormat date_farm=new SimpleDateFormat();
    ...
    public farm(String farm_id, String fram_name, String farm_address, String farm_details, String farm_tel, String picture,SimpleDateFormat date_farm) {
      if(farm_id==null){
          setFarm_id();
      }else{
          setnewid(farm_id);
...
public void setnewid(String id){
    ...
    public SimpleDateFormat getDate_farm() {
        return date_farm;
    }

    public void setDate_farm(SimpleDateFormat date_farm) {
        this.date_farm = date_farm;
    }
