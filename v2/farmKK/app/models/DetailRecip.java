...
@ManyToOne
private SaveFoods savefood;

    public DetailRecip() {
        setDid();
    }

    public DetailRecip( int amount, Inputfood inputfoods, Recipe recipe,int totalkg ,SaveFoods savefood) {
        setDid();
        this.amount = amount;
    ...
    public SaveFoods getSavefood() {
        return savefood;
    }

    public void setSavefood(SaveFoods savefood) {
        this.savefood = savefood;
    }
