...
public class UserKK extends Model {
    @Id
    private String id;
    private String User_Name,User_Password,position,name,lastname,address,email;
    private int tel,age;
...
setId();
    ...
    public UserKK(String user_Name, String user_Password, String position, String name, String lastname, String address, int tel, String email, int age) {
        setId();
        User_Name = user_Name;
