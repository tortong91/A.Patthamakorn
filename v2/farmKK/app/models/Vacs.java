...
public class Vacs extends Model {
    ...
    private List<Addcow_planvacs> vacaddList = new ArrayList<Addcow_planvacs>();
    public Vacs() {
...
//    }
    ...
    public static List<Vacs> vacList (String id){
        return finder.where().eq("vac.id",id).findList();
    }
